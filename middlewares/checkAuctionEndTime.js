// this middleware will verify if the user who is placing the bid is placing the bid
// for the currently running auction or not by verifying the end time of the auction
//  for which he is placing the bid
